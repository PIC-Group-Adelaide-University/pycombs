...
# ============================================================================
# DEDICATED LITERATURE EXAMPLE: Zhang et al. (2023), Fig. 3b, Type II
# double-pass; ideal effective coherent PM passes = 2; beta = ~2.1*pi.
...
class LLEState:
    ...
    def __init__(self):
        ...
        self.startup_config_name = "default_startup_zhang2023_fig3b_type_II_zero_coupling"
...
def run_gui():
    ...
    add_panel_textbox("recipe", "Recipe file name", "pycombs_recipe_zhang2023_fig3b_type_II.txt", right_y[1], side="right")
