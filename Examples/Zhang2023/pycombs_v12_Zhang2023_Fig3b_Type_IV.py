...
# ============================================================================
# DEDICATED LITERATURE EXAMPLE: Zhang et al. (2023), Fig. 3b, Type IV
# quadra-pass; ideal effective coherent PM passes = 4; beta = ~4.2*pi.
...
class LLEState:
    ...
    def __init__(self):
        ...
        self.startup_config_name = "default_startup_zhang2023_fig3b_type_IV_zero_coupling"
...
def run_gui():
    ...
    add_panel_textbox("recipe", "Recipe file name", "pycombs_recipe_zhang2023_fig3b_type_IV.txt", right_y[1], side="right")
