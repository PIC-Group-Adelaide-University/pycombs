...
# ============================================================================
# DEDICATED LITERATURE EXAMPLE: Zhang et al. (2023), Fig. 3b, Type III
# double-pass with TE0/TE1 mode multiplexing; ideal effective coherent PM passes = 2; beta = ~2.1*pi.
# This file models the ideal phase-modulation spectrum, not parasitic
# Fabry-Perot fringes or the detailed TE0/TE1 routing geometry.
# ============================================================================
...
STARTUP_PRESETS = {
    ...
    "default_startup_zhang2023_fig3b_type_I_zero_coupling": dict(
        # Zhang et al., Commun. Phys. 6, 17 (2023), Fig. 3b, Type I.
        # Literature-verified electrical parameters: 28 dBm RF drive, 24.95 GHz,
        # 50-ohm termination, RF Vpi = 7.56 V at 25 GHz. These give
        # Vpeak = sqrt(2*P*R) = 7.94 V and beta = pi*Vpeak/Vpi ~= 1.05*pi.
        # The 1550.8-nm carrier is used only to center the plotted spectrum near
        # the paper's telecom-band Fig. 3; Zhang et al. report wavelength-tunable
        # operation and do not specify 1550.8 nm as a unique Fig. 3b condition.
        number_modes=256,
        pump_wavelength_nm=1550.8,
        fsr_hz=24.95e9,
        Q=4e8,
...
class LLEState:
    ...
    def __init__(self):
        ...
        self.startup_config_name = "default_startup_zhang2023_fig3b_type_III_zero_coupling"
...
def run_gui():
    ...
    add_panel_textbox("recipe", "Recipe file name", "pycombs_recipe_zhang2023_fig3b_type_III.txt", right_y[1], side="right")
