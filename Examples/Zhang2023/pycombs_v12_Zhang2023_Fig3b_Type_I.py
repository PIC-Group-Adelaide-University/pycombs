...
# ============================================================================
# DEDICATED LITERATURE EXAMPLE: Zhang et al. (2023), Fig. 3b, Type I
# single-pass; ideal effective coherent PM passes = 1; beta = ~1.05*pi.
...
def run_gui():
    ...
    add_panel_textbox("recipe", "Recipe file name", "pycombs_recipe_zhang2023_fig3b_type_I.txt", right_y[1], side="right")
