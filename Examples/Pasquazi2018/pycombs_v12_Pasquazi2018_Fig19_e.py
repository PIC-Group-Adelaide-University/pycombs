...
STARTUP_PRESETS = {
    ...
    "default_startup_wilson2019_GaP": dict(
        ...
        pump_source="input_field_time.txt",
        startup_style="cw_only",
        noise_switch=True,
        pump_noise_enabled=True,
        cavity_noise_enabled=True,
...
class LLEState:
    ...
    def __init__(self):
        ...
        self.startup_config_name = "default_startup_pasquazi2018_fig19_exact_quadratic"
...
def run_gui():
    ...
    add_panel_textbox("recipe", "Recipe file name", "pycombs_recipe_pasquazi2018_fig19_to_Delta12.txt", right_y[1], side="right")
